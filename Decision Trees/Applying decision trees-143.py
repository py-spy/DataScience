...
tr_pred = clf.predict(train[columns])
train_auc = roc_auc_score(train['high_income'], tr_pred)

ts_pred = clf.predict(test[columns])
test_auc = roc_auc_score(test['high_income'], ts_pred)
