...
/home/dq/random_numbers$ git config --global user.name "Dataqu

## 6. Committing ##

/home/dq/random_numbers$ git commit -m "Initial commit. Added
...
/home/dq/random_numbers$ git commit -m "Made the numbers rando
